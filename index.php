...
<head>
    ...
    <title>Starter kit for static HTML Project</title>
    <meta name="description" content="Starter kit for static HTML Project, using Gulp and Bower.">
    <meta name="keywords" content="HTML,CSS,Gulp,Bower">
    ...
    <link rel="icon" type="image/png" href="/public/img/favicons/favicon-192x192.png" sizes="192x192">
    <link rel="icon" type="image/png" href="/public/img/favicons/favicon-160x160.png" sizes="160x160">
